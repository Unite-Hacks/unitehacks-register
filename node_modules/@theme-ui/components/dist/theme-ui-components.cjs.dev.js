...
var color = require('@styled-system/color');
...
var space__default = /*#__PURE__*/_interopDefault(space);
var color__default = /*#__PURE__*/_interopDefault(color);
var React__default = /*#__PURE__*/_interopDefault(React);

const boxSystemProps = [...space__default['default'].propNames, ...color__default['default'].propNames];
/**
 * @internal
...
const shouldForwardProp = shouldForwardProp$1.createShouldForwardProp(boxSystemProps);

const sx = props => css.css(props.sx)(props.theme);

const base = props => css.css(props.__css)(props.theme);

const variant = ({
  theme,
  variant,
  __themeKey = 'variants'
}) => css.css(css.get(theme, __themeKey + '.' + variant, css.get(theme, variant)));
...
const Box = styled__default['default']('div', {
  ...
  margin: 0,
  minWidth: 0
}, base, variant, space__default['default'], color__default['default'], sx, props => props.css);
Box.displayName = 'Box';
...
const Input = /*#__PURE__*/React__default['default'].forwardRef(function Input({
  ...
  return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
    ...
    variant: "input",
    sx: {
      '--theme-ui-input-autofill-bg': theme => css.get(theme.colors, autofillBackgroundColor, null),
      ...sx
    }
  }, rest, {
    __themeKey: "forms",
...
const RadioIcon = props => /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(RadioChecked, _extends({}, props, {
  __css: {
    display: 'none',
    'input:checked ~ &': {
      display: 'block'
...
})), /*#__PURE__*/React__default['default'].createElement(RadioUnchecked, _extends({}, props, {
  __css: {
    display: 'block',
    'input:checked ~ &': {
      display: 'none'
...
const CheckboxIcon = props => /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(CheckboxChecked, _extends({}, props, {
  __css: {
    display: 'none',
    'input:checked ~ &': {
      display: 'block'
...
})), /*#__PURE__*/React__default['default'].createElement(CheckboxUnchecked, _extends({}, props, {
  __css: {
    display: 'block',
    'input:checked ~ &': {
      display: 'none'
...
const Field = /*#__PURE__*/React__default['default'].forwardRef(function Field({
  ...
  return /*#__PURE__*/React__default['default'].createElement(Box, getMargin(props), /*#__PURE__*/React__default['default'].createElement(Label, {
    htmlFor: fieldIdentifier
  }, label), /*#__PURE__*/React__default['default'].createElement(Control, _extends({
    ref: ref,
    id: fieldIdentifier,
    name: name
  }, omitMargin(props))));
...
const x = /*#__PURE__*/React__default['default'].createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentcolor",
...
const Embed = /*#__PURE__*/React__default['default'].forwardRef(function Embed({
  ...
  }, getContainerProps(rest)), /*#__PURE__*/React__default['default'].createElement(Box, _extends({
    ref: ref,
    as: "iframe",
    src: src,
    width: width,
...
const AspectRatio = /*#__PURE__*/React__default['default'].forwardRef(function AspectRatio({
  ...
  }), /*#__PURE__*/React__default['default'].createElement(Box, _extends({}, props, {
    __css: {
      position: 'absolute',
      top: 0,
      right: 0,
...
const MenuButton = /*#__PURE__*/React__default['default'].forwardRef(function MenuButton(props, ref) {
  return /*#__PURE__*/React__default['default'].createElement(IconButton, _extends({
    ...
    variant: "menu"
  }, props), /*#__PURE__*/React__default['default'].createElement(MenuIcon, null));
});
